...
@section('content')
<div class="space-y-6">
    <h2 class="text-2xl font-bold text-gray-800">Formulir Tambah Data Kecamatan</h2>

    <div class="max-w-2xl bg-white p-6 rounded-lg shadow">
        <form action="{{ route('kependudukan.store') }}" method="POST">
            
            {{-- PERBAIKAN: Mengirimkan array kosong sebagai variabel $data --}}
            @include('kependudukan._form', ['data' => []])
